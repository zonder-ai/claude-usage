...
![Menu bar showing C: 42%](docs/menubar.png)

## Features

- Live usage percentage in the menu bar (5-hour window)
- Progress bars for both 5-hour and 7-day windows
- Color-coded levels (green → yellow → orange → red)
- Notifications when usage crosses configurable thresholds (default: 75%, 90%, 100%)
...
4. The app appears in your menu bar as `C: --%`

## Usage

- **Click the menu bar icon** to see the usage breakdown
- **Settings** — sign in with Claude OAuth if auto-detection didn't work, adjust notification thresholds, toggle Launch at Login
...
```bash
git clone https://github.com/zonder-ai/ai-usage-app.git
cd ai-usage-app
